...
def run_optimization_example(model_id: str = "xgboost_PSI200_mill7", log_file: str = None) -> Dict[str, Any]:
    """Run an optimization example with the specified model"""
    ...
    # Get path to results directory
    results_file = os.path.join(results_dir, f"optimization_results_{model_id}.json")
    ...
    csv_file = os.path.join(results_dir, f"optuna_trials_{model_id}.csv")
...
if __name__ == "__main__":
    ...
    run_optimization_example(model_id=model_id, log_file=log_file)