...
- Изградени са **прогнозни модели**, които предвиждат фиността на смилане (PSI80/PSI200) при различни режими на работа.
- Наличен е **симулатор** за предварителна проверка на сценарии без риск за реалния процес.
- Системата генерира **препоръки за целеви уставки**, осигуряващи желаната финост при максимална производителност.
...
- **Гранулометричен контрол** на смилането, вкл. внедрената система **CiDRA CYCLON Etrac (PST)** за проследяване на едрината на частиците.
- **Онлайн анализатор на пулпа (куриер/Courier)** и лабораторни проби за веществения състав на рудата и концентрата.
...
- **Флотацията** – корпусът с най-пряк ефект върху металургичното извличане.
