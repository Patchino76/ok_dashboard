...
// Use internal URL for proxying to avoid loops. Fallback to localhost:8001
const API_URL = process.env.API_INTERNAL_URL || "http://127.0.0.1:8001";
...
app
  ...
  .then(() => {
    ...
    console.log(`📡 Setting up proxy: /api, /docs -> ${API_URL}`);
    ...
    server.listen(port, (err) => {
      ...
      const hostname = API_URL.includes("://")
