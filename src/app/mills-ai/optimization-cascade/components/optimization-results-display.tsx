      ...
      >
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2 text-lg">
            ...
            <Badge
              variant="outline"
              className={`ml-auto bg-${performanceRating.color}-100 text-${performanceRating.color}-700 border-${performanceRating.color}-300`}
            >
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <div
                className={`text-2xl font-bold ${
                  results.target_achieved ? "text-green-600" : "text-amber-600"
                }`}
              >
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-slate-500">Най-добро отклонение</div>
            </div>
          </div>
          ...
          <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <p className="text-sm text-blue-700 dark:text-blue-400">
                  {Object.keys(results.best_mv_values).length > 0 ? (
                    <>
                      Промяна на{" "}
                      <span className="font-semibold">
                        {Object.keys(results.best_mv_values).length} параметъра
                      </span>{" "}
            ...
            <div className="mt-4 flex gap-2">
              {onApplyValues && (
                <Button
                  onClick={() => {
                    ...
                    toast.success(
                      "Оптималните стойности са приложени към слайдерите"
                    );
                  }}
              ...
              <Button
                variant="outline"
                onClick={() => {
                  const text = Object.entries(results.best_mv_values)
                    .map(([k, v]) => `${k}: ${(v as number).toFixed(2)}`)
                    .join("\n");
                  navigator.clipboard.writeText(text);
                  toast.success("Стойностите са копирани");
                }}
              >
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <ReferenceLine
                          ...
                          strokeDasharray="5 5"
                          label={{
                            value: `Най-добра: ${(bestValue as number).toFixed(
                              2
                            )}`,
                            position: "top",
                            fill: "hsl(25, 95%, 53%)",
