      ...
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Badge
              variant={!isOptimizing ? "default" : "destructive"}
              className="px-3 py-1"
            >
                ...
                <div>
                  ...
                  <div className="mt-3">
                    ...
                    <div className="flex justify-between text-xs text-slate-500 mt-1">
                      <span>
                        {Number.isFinite(scaleMin) ? scaleMin.toFixed(1) : "—"}
                        {targetUnit}
                      </span>
                      <span>
                        {Number.isFinite(scaleMax) ? scaleMax.toFixed(1) : "—"}
                        {targetUnit}
                      </span>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-1 hidden lg:flex items-center justify-center">
            <div className="h-[240px] flex flex-col items-center justify-between py-2">
              ...
              <div className="text-sm text-orange-500 font-medium">
                {typeof targetSetpoint === "number"
                  ? targetSetpoint.toFixed(1)
                  : "--"}
                {targetUnit}
              </div>
            </div>
                ...
                {chartData.length > 0 ? (
                  ...
                  <div className="h-full flex items-center justify-center">
                    <p className="text-slate-500">
                      No prediction data available. Adjust parameters and click
                      Predict.
                    </p>
                  </div>
                )}
