            ...
            <table className="w-full">
              <thead>
                <tr className="bg-white border-b border-gray-200">
                  <th className="px-3 py-2 text-left text-[11px] font-medium text-gray-700 uppercase tracking-wider">
                    Дата / Час
                  </th>
                  <th className="px-3 py-2 text-center text-[11px] font-medium text-gray-700 uppercase tracking-wider">
                    См
                  </th>
                  <th className="px-3 py-2 text-center text-[11px] font-medium text-gray-700 uppercase tracking-wider">
                    МШЦ
                  ...
                  <th className="px-3 py-2 text-right text-[11px] font-medium text-gray-700 uppercase tracking-wider">
                    Тегло [кг.]
                  </th>
                  <th className="px-3 py-2 text-left text-[11px] font-medium text-gray-700 uppercase tracking-wider">
                    Оператор
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {sectionRows.map((row, index) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-center whitespace-nowrap text-xs text-gray-700">
                      {row.shift}
                    </td>
                    <td className="px-3 py-2 text-center whitespace-nowrap text-xs text-gray-700">
                      {row.target}
                    ...
                    <td className="px-3 py-2 text-right whitespace-nowrap text-xs font-semibold text-gray-900">
