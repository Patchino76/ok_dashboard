...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <Box
        className={`sidebar-content fixed inset-y-0 left-0 z-40 bg-white border-r border-gray-200 py-4 w-[280px] flex flex-col transform transition-transform duration-300 ease-in-out ${
